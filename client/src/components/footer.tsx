...
import { ETHERSCAN_MUMBAI_POLYGON_TX_BASE_URL, COINFLIP_ADDRESS } from '../constants';
...
export const Footer = () => {
  return (
    <FooterContainer>
        ...
        <ContractLink href={`${ETHERSCAN_MUMBAI_POLYGON_TX_BASE_URL}${COINFLIP_ADDRESS}`} target="_blank">CoinFlip Contract on Polyscan<Polygon /></ContractLink>
    </FooterContainer>
  )
}
